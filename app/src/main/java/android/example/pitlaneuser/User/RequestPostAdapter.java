...
import android.example.pitlaneuser.Shop.ShopCommentActivity;
...
public class RequestPostAdapter extends RecyclerView.Adapter<RequestPostAdapter.ViewHolder>{
    ...
    public RequestPostAdapter(Context mContext, List<UserRequest> mPostList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        return new RequestPostAdapter.ViewHolder(view);
    }
